...
export function initUniverseStarField(): () => void {
	...
	function fitSolarSystemToViewport() {
		...
		// Desktop: keep orrery centered under the middle title.
		// Mobile: leave room for the top title band.
		const titleReserve = w < 768 ? 0.3 : 0.06;
